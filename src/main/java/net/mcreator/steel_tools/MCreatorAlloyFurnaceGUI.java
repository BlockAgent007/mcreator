...
public class MCreatorAlloyFurnaceGUI extends Elementssteel_tools.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorAlloyFurnaceGUI(Elementssteel_tools instance) {
		super(instance, 37);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorAlloyFurnace.TileEntityCustom)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("steel_tools:textures/alloyfurnacegui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Alloy Furnace", 6, 6, -12961222);
		}
