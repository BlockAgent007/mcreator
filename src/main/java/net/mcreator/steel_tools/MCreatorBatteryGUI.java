...
public class MCreatorBatteryGUI extends Elementssteel_tools.ModElement {
	public static int GUIID = 5;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorBatteryGUI(Elementssteel_tools instance) {
		super(instance, 81);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorBattery1.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 157, 4) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 80, 34) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("steel_tools:textures/batterygui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Battery", 5, 4, -13290187);
			this.fontRenderer.drawString("Power Stored:", 24, 60, -13158601);
		}
