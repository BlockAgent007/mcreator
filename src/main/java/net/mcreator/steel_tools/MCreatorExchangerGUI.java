...
public class MCreatorExchangerGUI extends Elementssteel_tools.ModElement {
	public static int GUIID = 4;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorExchangerGUI(Elementssteel_tools instance) {
		super(instance, 70);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorExchanger.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 153, 6) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(MCreatorExchangerBatteryCharger.block, (int) (1)).getItem() == stack.getItem());
				}
			});
			this.addSlotToContainer(new Slot(inherited, 1, 80, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(MCreatorBattery.block, (int) (1)).getItem() == stack.getItem());
				}
			});
			int si;
			int sj;
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				steel_tools.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("steel_tools:textures/exchangergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Exchanger", 5, 5, -13158601);
			this.fontRenderer.drawString("Status: " + (steel_toolsVariables.block_status) + "", 31, 56, -13421773);
		}
		...
		protected void actionPerformed(GuiButton button) {
			steel_tools.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
